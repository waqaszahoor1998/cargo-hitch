"""
Data entities for cargo hitchhiking simulation.
Defines Order, Driver, and Fleet data structures with business logic.
"""
...
class Driver:
    ...
    def _get_max_orders(self) -> int:
        """Get maximum number of orders based on vehicle type."""
        max_orders = {
            VehicleType.BIKE: 2,      # Increased from 1
            VehicleType.MOTORBIKE: 3,  # Increased from 2
            VehicleType.CAR: 5,        # Increased from 3
            VehicleType.VAN: 8         # Increased from 5
        }
        return max_orders.get(self.vehicle_type, 3)
